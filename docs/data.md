...
- **diff_unet_3d_rflow-mr-brain_v1.pt** — [MR-RATE](https://huggingface.co/datasets/Forithmus/MR-RATE) (batches 0–27): **73,020** unique subjects, **656,565** unique scans (axial/sagittal/coronal, whole-brain), covering T1w, T2w, FLAIR, SWI, and MRA in both whole-brain and skull-stripped variants. [Full table → §3.4](../data/README.md#34-diff_unet_3d_rflow-mr-brain_v1pt)
